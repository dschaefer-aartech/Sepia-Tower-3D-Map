...
function addSphere(myPos, myColour){
    ...
    sphere.position.x = myPos.x - 1;
    sphere.position.y = myPos.z - 1;
    sphere.position.z = -myPos.y - 1;

    scene.add(sphere);

}

function addColumn(columnSize, columnPosition, flatFlag){

    let myHeight = null;
    if (flatFlag == true){ myHeight = .1; } else { myHeight = 245; }
    ...
    const geometry = new THREE.BoxGeometry(columnSide,columnSide,myHeight);
    ...
    column.position.z = -columnPosition.y - myHeight/2;

    scene.add(column);

}

function addPrimaryColumns(flatFlag){

    // console.log("[myAux.js] addPrimaryColumns(): Hi.");

    addColumn(1, new THREE.Vector3(9298,65,724), flatFlag); // NW
    addColumn(1, new THREE.Vector3(9390,65,724), flatFlag); // NE
    addColumn(1, new THREE.Vector3(9390,65,816), flatFlag); // SE
    addColumn(1, new THREE.Vector3(9298,65,816), flatFlag); // SW

}

function addSecondaryColumns(flatFlag){

    // console.log("[myAux.js] addSecondaryColumns(): Hi.");

    addColumn(2, new THREE.Vector3(9334,65,726), flatFlag); // NW
    addColumn(2, new THREE.Vector3(9356,65,726), flatFlag);

    addColumn(2, new THREE.Vector3(9390,65,760), flatFlag); // NE
    addColumn(2, new THREE.Vector3(9390,65,782), flatFlag); 
    
    addColumn(2, new THREE.Vector3(9356,65,816), flatFlag); // SE
    addColumn(2, new THREE.Vector3(9334,65,816), flatFlag); 
    
    addColumn(2, new THREE.Vector3(9300,65,782), flatFlag); // SW
    addColumn(2, new THREE.Vector3(9300,65,760), flatFlag);

}

function addTertiaryColumns(flatFlag){

    // console.log("[myAux.js] addTertiaryColumns(): Hi.");

    // NW

    addColumn(3, new THREE.Vector3(9310,65,728), flatFlag);
    addColumn(3, new THREE.Vector3(9318,65,728), flatFlag);
    addColumn(3, new THREE.Vector3(9326,65,728), flatFlag);

    addColumn(3, new THREE.Vector3(9366,65,728), flatFlag);
    addColumn(3, new THREE.Vector3(9374,65,728), flatFlag);
    addColumn(3, new THREE.Vector3(9382,65,728), flatFlag);    

    // NE

    addColumn(3, new THREE.Vector3(9390,65,736), flatFlag);
    addColumn(3, new THREE.Vector3(9390,65,744), flatFlag);
    addColumn(3, new THREE.Vector3(9390,65,752), flatFlag);

    addColumn(3, new THREE.Vector3(9390,65,792), flatFlag);
    addColumn(3, new THREE.Vector3(9390,65,800), flatFlag);
    addColumn(3, new THREE.Vector3(9390,65,808), flatFlag);

    // SE

    addColumn(3, new THREE.Vector3(9382,65,816), flatFlag);
    addColumn(3, new THREE.Vector3(9374,65,816), flatFlag);
    addColumn(3, new THREE.Vector3(9366,65,816), flatFlag);

    addColumn(3, new THREE.Vector3(9326,65,816), flatFlag);
    addColumn(3, new THREE.Vector3(9318,65,816), flatFlag);
    addColumn(3, new THREE.Vector3(9310,65,816), flatFlag);

    // SW

    addColumn(3, new THREE.Vector3(9302,65,808), flatFlag);
    addColumn(3, new THREE.Vector3(9302,65,800), flatFlag);
    addColumn(3, new THREE.Vector3(9302,65,792), flatFlag);

    addColumn(3, new THREE.Vector3(9302, 65, 752), flatFlag);
    addColumn(3, new THREE.Vector3(9302, 65, 744), flatFlag);
    addColumn(3, new THREE.Vector3(9302, 65, 736), flatFlag);

}

function addColumns(flatFlag){

    addPrimaryColumns(flatFlag);
    addSecondaryColumns(flatFlag);
    addTertiaryColumns(flatFlag);
